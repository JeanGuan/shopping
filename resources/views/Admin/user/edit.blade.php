        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12">
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{url('/admin/user')}}">会员列表</a></li>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="body" >
                        <form id="form_validation" method="POST" action="{{url('admin/user/'.$field->id)}}">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-2 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <input type="text"  class="form-control" name="username" maxlength="16" minlength="4" value="{{$field->username}}" required>
                                    </div>
                                </div>
                            </div>
                            <!--管理员状态 -->
