    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Article</strong> Edit</h2>
                    </div>
                    <div class="body" >
                        <form id="form_validation" method="POST" action="{{url('admin/article/'.$field->id)}}">
                        ...
                        <!--分类名称 -->
                                ...
                                <div class="col-lg-2 col-md-10 col-sm-8">
                                    <select class="form-control show-tick" name="typeid">
                                        ...
                                        @foreach($arctype as $v)
                                            <option value="{{$v->id}}" @if($v->id == $field->typeid ) selected @endif >{{$v->typename}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-2 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        @if($field->img != null)
                                            <img src="{{$field->img}}" id="demo" class="img-responsive">
                                        @else
                                         <img src="{{asset('skin/timg.jpg')}}" id="demo" class="img-responsive">
                                        @endif
                                        <input type="text" name="img" id="img" autocomplete="off" class="form-control" value="{{$field->img}}" >
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-1 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <input type="text"  class="form-control" name="writer" value="{{$field->writer}}" >
                                    </div>
                                </div>
                            </div>
                            <!--发布时间 -->
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-2 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <input type="text"  id="test5" placeholder="y-M-d H:i:s" class="form-control" name="time" value="{{date('Y-m-d H:i:s',$field->time)}}" >
                                    </div>
                                </div>
                            </div>
                            <!--关键词 -->
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-2 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        ...
                                        <script id="editor" name="content" type="text/plain" style="width: 800px;height: 300px;" >{!! $field->content !!}</script>
