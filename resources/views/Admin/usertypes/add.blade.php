        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12">
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item"><a href="/admin/usertypes">会员类型列表</a></li>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>UserLevel</strong> Add</h2>
                    </div>
                    <div class="body" >
                        <form id="form_validation" method="POST" action="{{url('/admin/usertypes')}}">
                        {{csrf_field()}}
                            <!--级别名称 -->
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-2 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <input type="text"  class="form-control" name="typename" minlength="2" required>
                                    </div>
                                </div>
                            </div>
