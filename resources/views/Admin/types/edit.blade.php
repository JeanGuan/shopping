    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Types</strong> Edit</h2>
                    </div>
                    <div class="body" >
                        <form id="form_validation" method="POST" action="{{url('admin/types/'.$field->id)}}">
                        ...
                        <!--分类icon -->
                                ...
                                <div class="col-lg-2 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <div class="radio inlineblock m-r-20">
                                            <input type="radio" name="is_lou" id="male" class="with-gap" @if($field->is_lou == 0) checked @endif value="0" checked="">
                                            <label for="male">关闭</label>
                                        </div>
                                        <div class="radio inlineblock">
                                            <input type="radio" name="is_lou" id="Female" class="with-gap" @if($field->is_lou == 1) checked @endif value="1" >
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-1 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <input type="number"  class="form-control" name="sort" value="{{$field->sort}}" >
                                    </div>
                                </div>
                            </div>
                            <!--SEO标题 -->
