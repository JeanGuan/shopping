        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12">
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item active">编辑品牌</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="body" >
                        <form id="form_validation" method="POST" action="{{url('admin/brand/'.$brand->id)}}">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-2 col-md-10 col-sm-8">
                                    <select class="form-control show-tick" name="typeid">
                                        @foreach($types as $v)
                                            <option value="{{$v->id}}" @if($v->id == $brand->typeid) selected @endif>{{$v->typename}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        <!--品牌logo -->
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-2 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        @if($brand->img != null)
                                        <img src="{{$brand->img}}" id="demo" class="img-responsive">
                                        @else
                                            <img src="{{asset('skin/timg.jpg')}}" id="demo1" class="img-responsive">
                                        @endif

                                        <input type="text" name="img" id="img" autocomplete="off" class="form-control" value="{{$brand->img}}" required>
