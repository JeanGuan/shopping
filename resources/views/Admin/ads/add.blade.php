    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Ads</strong> Add</h2>
                    </div>
                    <div class="body" >
                        <form id="form_validation" method="POST" action="{{url('/admin/ads/')}}">
                        {{csrf_field()}}
                        ...
                        <!--标题 -->
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-2 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <input type="url"  class="form-control" name="href"  placeholder="Http://" required>
                                    </div>
                                </div>
                            </div>
                            <!--图片上传 -->
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-1 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <input type="number"  class="form-control" name="order_id"  value="0" >
                                        </div>
                                    </div>
                                </div>
