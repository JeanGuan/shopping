                ...
                <div class="card">
                    <div class="header">
                        ...
                        <ul class="header-dropdown">
                            <li class="dropdown">
                                <a href="{{url('/admin/ads/create')}}"  class="badge badge-warning">添加广告</a>
                            </li>
                        ...
                        <table class="table table-striped m-b-0">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('/admin/ads/'.$v->id.'/edit')}}" class="badge badge-success">编辑</a>
...
<script>
    ...
    function changeOrder(obj,id) {
        ...
        $.post('ads/changeOrder',{'_token':'{{csrf_token()}}','id':id,'order_id':order_id},function (data) {
            if (data.states == 1){
                setTimeout(function(){
