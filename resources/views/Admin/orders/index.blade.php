                ...
                <div class="card">
                    <div class="header">
                        ...
                        <ul class="header-dropdown">
                            <li class="dropdown">
                                <a href="{{url('/admin/orders/create')}}"  class="badge badge-warning">添加订单</a>
                            </li>
                       ...
                       <table class="table table-striped m-b-0">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td> <span class="badge badge-primary">{{$v->name}}</span></td>
                                    <td>
                                        <a href="{{url('admin/orders/details?code='.$v->code)}}" class="badge badge-success">订单详情</a>
                                        <a href="{{url('admin/orders/status/edit/'.$v->sid)}}"   class="badge badge-danger">修改状态</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
