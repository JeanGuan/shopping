...
<link href="{{asset('/skin/style/webstyle.css')}}" rel="stylesheet" type="text/css" />
<script src="{{asset('/skin/js/jquery-1.11.3.js')}}" type="text/javascript"></script>
<script src="{{asset('/skin/js/banner.js')}}"></script>
<!-- layer -->
	...
	<div class="login_bor">
			...
			<ul>
				...
				<li>
					...
					<div class="fr login_con_inp" id="cc">
						...
						<a class="fr login_con_yzm_pic"><img src="{{url('/code')}}" alt="" onclick="this.src='{{url('/code')}}?'+Math.random()" /></a>
						@if(session('msg'))
		...
		<div class="fr login_r">
			<div class="login_tit tc">
				<a >已注册？</a>
				<a href="{{url('/login')}}" class="login_tit_on">登陆</a>
			</div>
