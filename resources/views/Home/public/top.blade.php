<div class="top_bg min_w">
	<div class="index_box f12">
		...
		@if(session('Homeuserinfo.id'))
			欢迎<a href="{{url('/person')}}" class="fl">{{session('Homeuserinfo.username')}}</a>登录！|
			<a href="/logout">退出</a>
		@else
		<a href="{{url('login')}}" class="fl">请登录</a>
...
href="javascript:void(0)" class="fr">收藏本站</a>
		...
		<a href="{{url('/cart')}}" class="fr"><img src="/skin/images/a02.png" width="20" height="40" alt="" />购物车0<img src="/skin/images/a07.png"/></a>
