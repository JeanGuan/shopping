...
<!-- 图片上传css -->
<link href="<?php echo e(asset('skin/Fileinput/css/fileinput.css')); ?>" rel="stylesheet">
<script src="<?php echo e(asset('skin/Fileinput/js/jquery-1.11.1.min.js')); ?>"></script>
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12">
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(url('/admin/goods')); ?>">商品列表</a></li>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="body" >
                        <form id="form_validation" method="POST" action="<?php echo e(url('admin/goods/'.$goods->id)); ?>">
                        ...
                        <!--标题 -->
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-2 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <input type="text"  class="form-control" name="title" value="<?php echo e($goods->title); ?>" required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-2 col-md-10 col-sm-8">
                                    <select class="form-control show-tick" name="tid">
                                        <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option  value="<?php echo e($v->id); ?>" <?php if($goods->tid == $v->id): ?> selected <?php endif; ?> ><?php echo e($v->typename); ?></option>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-2 col-md-10 col-sm-8">
                                    <select class="form-control show-tick" name="bid"  onchange="chooseAttr(this.value);">
                                        <?php $__currentLoopData = $brand; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option  value="<?php echo e($v->id); ?>" <?php if($goods->bid == $v->id): ?> selected <?php endif; ?> ><?php echo e($v->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-2 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <input type="number"  class="form-control" name="oldprice" value="<?php echo e($goods->oldprice); ?>">
                                    </div>
                                </div>
                            </div>
                            <!--优惠价格 -->
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-2 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <input type="text"  class="form-control" name="price" value="<?php echo e($goods->price); ?>" >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="attr_area">
                                ...
                                <?php if($attr): ?>
                                    <?php $__currentLoopData = $attr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="row clearfix" id="attrs<?php echo e($k); ?>_group">
                                            <div class="col-lg-1 col-md-2 col-sm-4 form-control-label">
                                                <label for="price"><?php echo e($v['title']); ?>:<input type="hidden" name="attrs_group[]" value="<?php echo e($v['title']); ?>">
                                                </label>
                                            </div>
                                            <div class="col-lg-6 col-md-10 col-sm-8">
                                                <div class="form-group">
                                                    <div class="row clearfix">
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control" id="attrs<?php echo e($k); ?>_add" value=""/>
                                                            </div>
                                                            <span id="attrs<?php echo e($k); ?>_area">
                                                                <?php $__currentLoopData = $attr[$k]['attrs']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ks=>$vs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <input type="checkbox" name="attrs<?php echo e($k); ?>[]" value="<?php echo e($attr[$k]['attrs'][$ks]); ?>" checked><?php echo e($attr[$k]['attrs'][$ks]); ?>
                                                         ...
                                                         <div class="col-sm-8">
                                                                <div class="form-group">
                                                                    <button type="button" class=" btn btn-default btn-round" onclick="addinput('<?php echo e($k); ?>')">添加</button>
                                                                </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row clearfix">
                                            <table class="table table-striped table-hover table-bordered">
                                                ...
                                                <tr id="theadtr">
                                                    <?php if($attr): ?>
                                                        <?php $__currentLoopData = $attr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <th><?php echo e($a['title']); ?></th>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <?php endif; ?>
                                                    <th id="trhead">价格</th>
                                                    <th>原价</th>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-3 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        ...
                                        <?php if($goods->picurl != null): ?>
                                            <input type="hidden" id="picurl" placeholder="缩略图" name="picurl" value="<?php echo e($goods->picurl); ?>" >
                                        <?php endif; ?>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <div class="col-sm-11">
                                            ...
                                            <?php if($pic != null): ?>
                                                <?php $__currentLoopData = $pic; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as &$i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <input type="hidden" value="<?php echo e($i['img']); ?>" name="picimg[]" flag="<?php echo e($i['info']); ?>" show="" >
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-2 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <input type="text"  class="form-control" name="keywords" value="<?php echo e($goods->keywords); ?>" >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-2 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <textarea name="description" cols="30" rows="5"  class="form-control no-resize"  aria-required="true"><?php echo e($goods->description); ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <!--状态 -->
                                ...
                                <div class="col-lg-2 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <div class="radio inlineblock m-r-20">
                                            <input type="radio" name="status" <?php if($goods->status == 0): ?> checked <?php endif; ?> id="male" class="with-gap" value="0" >
                                            <label for="male">上架</label>
                                        </div>
                                        <div class="radio inlineblock">
                                            <input type="radio" name="status" <?php if($goods->status == 1): ?> checked <?php endif; ?> id="Female" class="with-gap" value="1" >
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-7 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <textarea id="ckeditor" name="parameter"><?php echo e($goods->parameter); ?> </textarea>
                                    </div>
                                </div>
                            </div>
                            <!--内容 -->
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-2 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <script type="text/javascript" charset="utf-8" src="<?php echo e(url('/org/ueditor/ueditor.config.js')); ?>"></script>
                                        <script type="text/javascript" charset="utf-8" src="<?php echo e(url('/org/ueditor/ueditor.all.min.js')); ?>"> </script>
                                        <script type="text/javascript" charset="utf-8" src="<?php echo e(url('/org/ueditor/lang/zh-cn/zh-cn.js')); ?>"></script>
                                        <script type="text/javascript">
                                            //实例化编辑器
                                            var ue = UE.getEditor('editor');
                                        </script>
                                        <script id="editor" name="content" type="text/plain"   ><?php echo $goods->content; ?></script>
...
<script>
    ...
    function fileinputOne(fileid,field){
        ...
        $input.fileinput({
            uploadUrl: "<?php echo e(url('admin/uploads')); ?>",
            deleteUrl: "<?php echo e(url('admin/updel')); ?>",
            uploadExtraData: {_token:'<?php echo e(csrf_token()); ?>'},  //额外的参数
            autoReplace: true,
...
<!--商品属性 笛卡尔积 -->
<script src="<?php echo e(asset('skin/descates.js')); ?>"></script>
<script>
    $(document).ready(function() {
        //笛卡尔积初始化
        descates();
...
<script>
    function chooseAttr(val){
        $.ajax({
            url: "<?php echo e(url('admin/goods/getAttr')); ?>",        //提交的页面，方法名
            dataType: "json",                               //类型
            data:{typeid:val,_token:'<?php echo e(csrf_token()); ?>'},
            type: "POST",                                   //提交方式
...
<!-- 图片上传 -->
<script src="<?php echo e(asset('skin/Fileinput/js/fileinput.js')); ?>"></script>
<?php $__env->stopSection(); ?>
