...
<!-- layer -->
    <link rel="stylesheet" href="<?php echo e(asset('skin/layer/css/layui.css')); ?>">
    ...
    <ul class="nav navbar-nav navbar-left">
        <li>
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo e(url('/admin')); ?>"><img src="/assets/images/logo.svg" width="30" alt="Oreo"><span class="m-l-10">Oreo</span></a>
            </div>
        </li>
        ...
        <li class="float-right">
            <a href="<?php echo e(url('admin/flush')); ?>" title="清除缓存" data-close="true"><i class="zmdi zmdi-refresh zmdi-hc-fw zmdi-hc-spin"></i></a>
            ...
            <a href="<?php echo e(url('admin/logout')); ?>" title="注销登录" class="mega-menu" data-close="true"><i class="zmdi zmdi-power"></i></a>
                ...
                <ul class="list">
                    <li>
                        <div class="user-info">
                            ...
                            <div class="detail">
                                <h4><?php echo e(session('jeanuserinfo.name')); ?></h4>
                    ...
                    <li class="active open"> <a href="javascript:void(0);" ><i class="zmdi zmdi-home"></i><span>系统主页</span></a></li>
                    <li class="<?php echo e(Request::getPathinfo()=='/admin' ? 'active open':''); ?>" > <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-widgets zmdi-hc-fw "></i><span>商品管理</span> </a>
                        <ul class="ml-menu">
                            <li class="<?php echo e(Request::getPathinfo()=='/admin/goods' ? 'active':''); ?>"> <a href="<?php echo e(url('/admin/goods')); ?>" >商品列表</a></li>
                            <li> <a href="<?php echo e(url('/admin/types')); ?>" >商品分类</a></li>
                            <li><a href="<?php echo e(url('/admin/brand')); ?>" >商品品牌</a></li>
                            <li><a href="<?php echo e(url('/admin/comment')); ?>" >商品评论</a></li>
                        </ul>
                    </li>
                    <li > <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment zmdi-hc-fw"></i><span>订单管理</span> </a>
                        <ul class="ml-menu">
                            <li> <a href="<?php echo e(url('/admin/orders')); ?>" >订单列表</a></li>
                            <li> <a href="<?php echo e(url('/admin/orders/status')); ?>" >订单状态</a></li>
                        </ul>
                    </li>
                    <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-file-text zmdi-hc-fw"></i><span>文章管理</span> </a>
                        <ul class="ml-menu">
                            <li> <a href="<?php echo e(url('/admin/article')); ?>" >文章列表</a></li>
                            <li> <a href="<?php echo e(url('/admin/arctype')); ?>" >文章分类</a></li>
                        </ul>
                    </li>

                    <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-account-circle zmdi-hc-fw"></i><span>会员管理</span> </a>
                        <ul class="ml-menu">
                            <li> <a href="<?php echo e(url('/admin/user')); ?>" >会员列表</a></li>
                            <li> <a href="<?php echo e(url('/admin/usertypes')); ?>" >会员类型</a></li>
                        </ul>
                    </li>
                    <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-view-dashboard zmdi-hc-fw"></i><span>模块管理</span> </a>
                        <ul class="ml-menu">
                            <li><a href="<?php echo e(url('/admin/slider')); ?>" >图片轮播</a></li>
                            <li><a href="<?php echo e(url('/admin/ads')); ?>" >广告管理</a></li>
                        </ul>
                    </li>
                    <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-account zmdi-hc-fw"></i><span>管理员管理</span> </a>
                        <ul class="ml-menu">
                            <li><a href="<?php echo e(url('/admin/admin')); ?>" >管理员列表</a></li>
                            <li><a href="<?php echo e(url('/admin/admintypes')); ?>" >管理组</a></li>

                        </ul>
                    </li>
                    <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-settings zmdi-hc-fw"></i><span>系统管理</span> </a>
                        <ul class="ml-menu">
                            <li> <a href="<?php echo e(url('admin/flush')); ?>">清除缓存</a></li>
                            <li> <a href="<?php echo e(url('admin/config')); ?>">系统配置</a></li>
