    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 ">
                <div class="card">
                    <div class="header">
                        <h2><strong>Goods</strong> Add</h2>
                    </div>
                    <div class="body" >
                        <form id="form_validation" method="POST" action="<?php echo e(url('/admin/goods/')); ?>">
                        <?php echo e(csrf_field()); ?>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-2 col-md-10 col-sm-8">
                                    <select class="form-control show-tick" name="tid"  onchange="chooseAttr(this.value);">
                                       <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option  value="<?php echo e($v->id); ?>"><?php echo e($v->typename); ?></option>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-2 col-md-10 col-sm-8">
                                    <select class="form-control show-tick" name="bid">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-3 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="picurl" placeholder="缩略图" name="picurl" value="">
                                    </div>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-3 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <textarea name="description" cols="20" rows="5"  class="form-control no-resize"  aria-required="true"></textarea>
                                    </div>
                                </div>
                            </div>
                            <!--状态 -->
